...
<style lang="scss">
	...
	@font-face {
        ...
        font-style: normal;
		font-weight: 100;
        src:local('Sofia Pro'), url(../../../intentio/static/fonts/SofiaProRegular.otf) format('otf');
    }
	...
	@font-face {
        ...
        font-style: normal;
		font-weight: 500;
        src:local('Sofia Pro'), url(../../../intentio/static/fonts/SofiaProMedium.otf) format('otf');
    }
	...
	@font-face {
		...
		font-style: normal;
		font-weight: normal;
		src:local('SofiaProSemiBold'), url(../../../intentio/static/fonts/SofiaProSemiBold.otf) format('otf');
	}
